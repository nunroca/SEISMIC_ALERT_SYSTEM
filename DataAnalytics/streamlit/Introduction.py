...
with formula1:
    st.markdown('<div class="block_formulas"><p class="title_3_dark">Response Time [RT] =</p><p class="textDark">Alert Time - Event Time</p></div>', unsafe_allow_html=True)

with formula2:
    st.markdown('<div class="block_formulas"><p class="title_3_dark">Number of Views [NºV] =</p><p class="textDark">Number of Views on Twitter</p></div>', unsafe_allow_html=True)
 
with formula3:
    st.markdown('<div class="block_formulas"><p class="title_3_dark">Reliability [R]  =</p><p class="textDark">Number of Correct Classifications / Total Test Events</p></div>', unsafe_allow_html=True)


st.markdown('<p class="title_2">Formulas</p>', unsafe_allow_html=True)

formula1, formula2, formula3 = st.columns(3)

with formula1:
    st.markdown('<div class="block_formulas"><p class="title_3_dark">KPI 1 =</p><p class="textDark">[(RTactual-RTpast)/ RTpast]*100%</p></div>', unsafe_allow_html=True)

with formula2:
    st.markdown('<div class="block_formulas"><p class="title_3_dark">KPI 2 =</p><p class="textDark">[(NºVactual-Nº_past)/Nº_past]*100%</p></div>', unsafe_allow_html=True)
 
with formula3:
    st.markdown('<div class="block_formulas"><p class="title_3_dark">KPI 3  =</p><p class="textDark">[Ractual-R_past)/R_past]*100%</p></div>', unsafe_allow_html=True)
